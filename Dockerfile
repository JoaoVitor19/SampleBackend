...
WORKDIR /src
COPY ["InitialSetupBackend.csproj", "."]
RUN dotnet restore "./InitialSetupBackend.csproj"
COPY . .
WORKDIR "/src/."
RUN dotnet build "./InitialSetupBackend.csproj" -c $BUILD_CONFIGURATION -o /app/build

# Esta fase é usada para publicar o projeto de serviço a ser copiado para a fase final
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./InitialSetupBackend.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=true
...
ENTRYPOINT ["./InitialSetupBackend"]